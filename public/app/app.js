...
// main config file
angular.module('userApp', ['appRoutes', 'userControllers', 'userServices', 'ngAnimate', 'mainController', 'authServices', 'homeController', 'detailsController', 'favCollectionBook', 'readCollectionBook', 'stillreadCollectionBook', 'toreadCollectionBook']) /// taka se pravi application v angular .. [] - tova da dependansitata koito iskame da izpolzvame routes,animation i tn
